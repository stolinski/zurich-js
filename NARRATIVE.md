...
| 25 | `phosphor-exit` | (the glass reforms around the last chart) | **Out through the faceplate.** The deposits fade and the glass reforms over this one flight, which is the occlusion that carries the phosphor stage out — the cubicle is a room shot, and a set swap needs a covering glass with a picture on it. Nothing new is said on it; it holds the skill/enjoyment split the room left behind. (The grill was this beat's arrival until 2026-09-10, when it moved after the agent count; the hold is back for the swap's sake, as it was before 2026-09-02.) |
...
|---|---|---|---|
| 26 | `return-cubicle` | `cubicle`, "you have to be allowed / to stop." on the monitor | **The ceiling.** Everything about to be said assumes you're allowed to stop. Against a quota, or a manager who treats the tool as a magic bullet, a 15-minute timer will not save you. Healthy prompting cannot be carried by personal discipline alone. The line stays on the monitor for the whole beat; `act-ceiling`, `early-career` and its caveat were cut 2026-09-02. |
| 27 | `act-boundaries` | `cubicle`, glass | "go for a walk." over a perspective line drawing of a path through bare line trees, walked along at walking pace. |
