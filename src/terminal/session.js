...
export const QUOTE_SHIP = screen('quote-ship')
export const QUOTE_ARCHITECTURE = screen('quote-architecture')
export const QUOTE_FOMO = screen('quote-fomo')
export const QUOTE_SPARK_LOST = screen('quote-spark-lost')
export const QUOTE_SPARK = screen('quote-spark')
