...
def build_materials() -> dict[str, bpy.types.Material]:
    ...
    materials = {
        ...
        "upright": principled_material("Rack upright", "#222b29", 0.42, metallic=0.48),
        "shelf": principled_material("Rack shelf", "#1b2322", 0.5, metallic=0.36),
        "panel": principled_material("Rack panel", "#12181a", 0.84, metallic=0.12),
        "tray": principled_material("Cable tray", "#59615e", 0.44, metallic=0.58),
        "bundle": principled_material("Cable bundle", "#0c0d0d", 0.8),
        "cable": principled_material("Power cable", "#0a0b0d", 0.62, metallic=0.05),
        "trench": principled_material("Trench cover", "#303735", 0.58, metallic=0.24),
